...
When Codex builds Aleph3 with MSBuild on Windows or encounters
`FileTracker`/environment failures, follow
[`docs/agents/windows-codex-build.md`](docs/agents/windows-codex-build.md).
