...
- `tests/sdk/EngineTests.cpp`
  Confirms the SDK facade links and returns structured placeholder errors.
...
4. Engine-scoped function registration must avoid global mutable behavior.
5. Evaluation budgets must fail with structured runtime errors.
