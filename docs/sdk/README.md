...
- The symbolic polynomial tier now supports product-facing `Expand`, `Factor`, `Collect`, `GCD`, `PolynomialQuotient`, `Numerator`, `Denominator`, `Together`, and `Cancel` from that CLI surface
