...
and smoke-test details for dormant web/API experiments. This is a developer
runbook for existing code, not a product plan. Current product sequencing lives
in the [Aleph3 Unified Plan](aleph3_unified_plan.md), and near-term work
targets the local notebook.
