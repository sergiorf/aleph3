...
const std::unordered_map<std::string, FunctionSemantics>& function_semantics_registry() {
    static const std::unordered_map<std::string, FunctionSemantics> value = {
        ...
        {"PolynomialRemainder", arity_range_semantics(EvaluationMode::Eager, DispatchKind::Default, false, false, false, false, false, false, 2, 3)},
        {"PolynomialDegree", exact_arity_semantics(EvaluationMode::Eager, DispatchKind::Default, false, false, false, false, false, false, 2)},
        {"LeadingCoefficient", exact_arity_semantics(EvaluationMode::Eager, DispatchKind::Default, false, false, false, false, false, false, 2)},
        {"Coefficient", arity_range_semantics(EvaluationMode::Eager, DispatchKind::Default, false, false, false, false, false, false, 2, 3)},
